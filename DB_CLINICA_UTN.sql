...
BEGIN TRY
    ...
    INSERT INTO CONTACTO (TELEFONO, EMAIL, DIRECCION)
    VALUES (@TELEFONO, @EMAIL, @DIRECCION);
...
BEGIN CATCH
    ...
    RAISERROR ('NO SE PUDO REGISTRAR PERSONA. Error %d en la línea %d: %s', 16, 1, @ErrorNumber, @ErrorLine, @ErrorMessage);
END CATCH;
