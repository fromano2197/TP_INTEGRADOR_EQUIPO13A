                        ...
                        <asp:Repeater ID="repRepeaterEspecialidad" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnModificar" CommandName="Modificar" CommandArgument='<%# Eval("IdEspecialidad") %>' OnCommand="btnModificar_Command" CssClass="btn-especialidad modificar" runat="server" Text="Modificar" />
                                        <asp:Button ID="btnEliminar" CommandName="Eliminar" CommandArgument='<%# Eval("IdEspecialidad") %>' OnCommand="btnEliminar_Command" CssClass="btn-especialidad eliminar" runat="server" Text='<%# Eval("activo").ToString() == "True" ? "Eliminar" : "Activar" %>' />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
