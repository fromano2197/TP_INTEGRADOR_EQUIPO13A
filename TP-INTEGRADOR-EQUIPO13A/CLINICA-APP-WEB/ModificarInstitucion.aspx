 ...
 <h1 class="titulo-principal">MODIFICAR INSTITUCION</h1>
    ...
    <div class="contenedor-formulario">
        <div class="grupo-formulario">
            <label for="txtIDInstitucion" class="etiqueta-formulario">Id Especialidad:</label>
            <asp:TextBox ID="txtIDInstitucion" CssClass="entrada-formulario" runat="server" placeholder="ID" Enabled="false"/>
