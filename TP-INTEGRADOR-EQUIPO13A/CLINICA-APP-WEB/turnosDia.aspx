                       ...
                       <asp:Repeater ID="repRepeater" runat="server">
                           <ItemTemplate>
                               <tr>
                                   ...
                                   <td>
                                       <asp:Button ID="btnObservaciones" CommandName="Observaciones" OnCommand="btnObservaciones_Command" CommandArgument='<%# Eval("IdTurno") %>' CssClass="btn-especialidad visualizar" runat="server" Text="Agregar Observacion"/>
                                       <asp:Button ID="btnDetalles" CommandName="Detalles" OnCommand="btnDetalles_Command" CommandArgument='<%# Eval("Paciente.IdPaciente") %>' CssClass="btn-especialidad visualizar" runat="server" Text="Ver detalle de Paciente" />
                                       <asp:Button ID="btnHistoria" CommandName="HistoriaClinica" OnCommand="btnHistoria_Command" CommandArgument='<%# Eval("Paciente.IdPaciente") %>' CssClass="btn-especialidad visualizar" runat="server" Text="Descargar Historia Clínica" />
